# -*- coding: utf-8 -*-
"""COVID_Dashboard_demo_1.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QtiOIXooDz0poy7LaL0Q1V7_1SgX6xMg
...
"""## Graph_Contaoner_for_DASH"""

def graph1():
    return dcc.Graph(id='graph1',figure=fig_world_trend('US'))

"""## Generate_CARDS_for_overall_numbers"""
...
"""### DASH_Slider_for_moving_average_window"""
...
# Run the pip freeze command and write the output to the requirements.txt file
os.system(f"pip freeze > {requirements_file}")

print(f"requirements.txt file created at: {requirements_file}")
